...
static int rcar_vcon_crtc_atomic_check(struct drm_crtc *crtc, struct drm_atomic_state *state)
{
	struct drm_crtc_state *crtc_state = drm_atomic_get_new_crtc_state(state, crtc);
	struct rcar_vcon_crtc_state *rstate = to_rcar_crtc_state(crtc_state);
...
static void rcar_vcon_crtc_atomic_enable(struct drm_crtc *crtc, struct drm_atomic_state *state)
{
...
static void rcar_vcon_crtc_atomic_disable(struct drm_crtc *crtc, struct drm_atomic_state *state)
{
	struct rcar_vcon_crtc *rcrtc = to_rcar_crtc(crtc);
