...
static const struct sh_pfc_pin_group pinmux_groups[] = {
	...
	BUS_DATA_PIN_GROUP(mmc_data8, 1),
	BUS_DATA_PIN_GROUP(mmc_data8, 4),
	BUS_DATA_PIN_GROUP(mmc_data8, 8),
	...
	BUS_DATA_PIN_GROUP(qspi0_data4, 2),
	BUS_DATA_PIN_GROUP(qspi0_data4, 4),
	SH_PFC_PIN_GROUP(qspi1_ctrl),
	BUS_DATA_PIN_GROUP(qspi1_data4, 2),
	BUS_DATA_PIN_GROUP(qspi1_data4, 4),
