...
static int xt_cma_helper_bootmem_page_pool_sz = SZ_64M;

/* The size of the boot memory in MiB for CMA allocator. */
static int xt_cma_helper_bootmem_cma_pool_sz = SZ_128M;
...
void __init xt_cma_helper_init(void)
{
	...
	xt_cma_helper_bootmem_page_pool_phys =
		memblock_phys_alloc_range(xt_cma_helper_bootmem_page_pool_sz,
				    SZ_2M, 0, XT_CMA_HELPER_MAX_ADDR);

	xt_cma_helper_bootmem_cma_pool_phys =
		memblock_phys_alloc_range(xt_cma_helper_bootmem_cma_pool_sz,
				    SZ_2M, 0, XT_CMA_HELPER_MAX_ADDR);
